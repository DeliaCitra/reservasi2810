...
<head>
    ...
    <title>Asriloka - PAKET PERUSAHAAN</title>
            ...
            <div class="col-lg-12 col-md-12 px-4">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 px-4">
                            <?php
                            $sql = "SELECT * FROM bundling WHERE type='PERUSAHAAN'";
                            ...
                            foreach ($bundling as $key => $value) {
                                ...
                                $html .= "<a href='details?type=paketPERUSAHAAN&id=$value[id]' class='btn btn-outline-dark shadow-none me-lg-3 me-2'>Book Now</a>";
                                $html .= "</div>";
                                $html .= "</div>";
                                $html .= "</div>";
                                echo $html;
