    ...
    <div class="container mt-5">
        <div class="row">
                            ...
                            if (count($booking) != 0) {
                                ...
                                foreach ($booking as $key => $value) {
                                    ...
                                    if ($value['status'] == 'BOOKED' && $value['paymentMethod'] == 'DP') {
                                        ...
                                        $html .= "<td><div class='text-center' style='width:215px;'><div>";
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="uploadBuktiPembayaranLabel">Upload Bukti Pembayaran</h5>
            ...
            <div </div>
                <?php
                if (isset($_SESSION['data'])) {
                    echo "<h5 class='text-center mt-4'><strong>No Rekening Asriloka</strong></h5>";
                    ...
                    echo "<div class='card mt-4 mb-4 p-4'>";
                ...
                $(document).on('click', '.viewBookingBtn', function () {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            html += "<table class='table table-striped' style='width:750px;'>";
                            html += "<thead>";
                            html += "<tr>";
                            html += "<th scope='col'>Room</th>";
                            html += "<th scope='col'>Check In</th>";
