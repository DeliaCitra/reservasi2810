...
<body class="bg-light">
    ...
    <div class="container">
        <div class="row">
            ...
            foreach ($res as $row) {
                echo "<div class='col-lg-2 col-md-2 mb-4'>";
                echo "<div class='card h-100 bg-white rounded shadow'>";
                echo "<img src='./assets/images/facility/" . $row['picture'] . "' class='card-img-top p-4' alt='" . $row['name'] . "'>";
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-4 mb-3 bg-white rounded p-0">
