...
<body class="bg-light">
    ...
    <div class="container-fluid"> <button type="button" class="btn btn-primary my-2" data-bs-toggle="modal"
            ...
            <i class="bi bi-plus-circle-fill"></i> Tambah Paket LDKS
        </button>
        <div class="col-lg-12 ">
            <div class="row">
    ...
    <script>$(document).ready(function () {
            ...
            function loadLDK() {
                console.log("loadLDK");
                $.ajax({
                    url: "ajax/bundling.php?action=loadLDK",
                    type: "GET",
                    dataType: "json",
                    success: function (data) {
                        console.log(data);
            ...
            $("#tambahBundlingLDK").on("submit", function (e) {
                e.preventDefault();
                ...
                $.ajax({
                    url: "ajax/bundling.php?action=tambahBundlingLDK",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $("#editBundling").on("submit", function (e) {
                ...
                if (formData.get("edit_image") != []) {
                    $.ajax({
                        url: "ajax/bundling.php?action=editBundlingLDK",
                        type: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,
            ...
            $("#hapusBundling").on("submit", function (e) {
                e.preventDefault();
                $.ajax({
                    url: "ajax/bundling.php?action=hapusBundlingLDK",
                    type: "POST",
                    data: $(this).serialize(),
                    success: function (response) {
                        console.log(response);
