...
<body class="bg-light">
    ...
    <div class="container-fluid">
        <button type="button" class="btn btn-primary my-2" data-bs-toggle="modal" data-bs-target="#addRoom">
            <i class="bi bi-plus-circle-fill"></i> Tambah Paket Camp
        </button>
        <div class="col-lg-12 ">
            <div class="row">
    ...
    <script>$(document).ready(function () {
            ...
            function loadCAMP() {
                console.log("loadCAMP");
                $.ajax({
                    url: "ajax/bundling.php?action=loadCAMP",
                    type: "GET",
                    dataType: "json",
                    success: function (data) {
                        console.log(data);
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            html += "<td class='text-center'><p><b> Rp. " + data[i].price + "</b></p></td>";
                            html += "<td><ul>";
                            ...
                            html += "</ul></td>";
                            html += "<td class='text-center d-flex gap-2'>";
            ...
            $("#tambahBundlingCAMP").on("submit", function (e) {
                e.preventDefault();
                ...
                $.ajax({
                    url: "ajax/bundling.php?action=tambahBundlingCAMP",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $("#editBundling").on("submit", function (e) {
                ...
                if (formData.get("edit_image") != []) {
                    $.ajax({
                        url: "ajax/bundling.php?action=editBundlingCAMP",
                        type: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,
            ...
            $("#hapusBundling").on("submit", function (e) {
                e.preventDefault();
                $.ajax({
                    url: "ajax/bundling.php?action=hapusBundlingCAMP",
                    type: "POST",
                    data: $(this).serialize(),
                    success: function (response) {
                        console.log(response);
