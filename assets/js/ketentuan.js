    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        for (i = 0; i < data.length; i++) {
          ...
          html +=
            "<td class='d-grid gap-2 d-md-flex justify-content-md-center'><button type='button' data-bs-toggle='modal' data-bs-target='#staticBackdropUmumEdit' class='btn btn-primary me-2' data-id='" +
            data[i].id +
            "' data-isGeneral='" +
            data[i].isGeneral +
            "' data-description='" +
